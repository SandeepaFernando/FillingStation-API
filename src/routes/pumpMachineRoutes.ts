...
import { createPumpMachine, deletePumpMachine, getPumpMachineById, updatePumpMachine } from "../controllers/pumpMachineController";
const route = Router()
...
route.post('/edit', async (req, res, next) => {
    ...
    const request = await updatePumpMachine(id, pumpName, meter, pumpOperator, tank)
